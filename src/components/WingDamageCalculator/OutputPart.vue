  ...
  computed: {
    ...
    supportIdolBaseAppeal() {
      ...
      for(let i = 0 ;  i < 4 ; i++) {
        ...
        baseAppeal.vocal = Number.parseInt(((this.produceIdolStatus.vocalStatus * 0.5) + ((supportIdol.vocalStatus * 3) + notSupportIdol[0].vocalStatus + notSupportIdol[1].vocalStatus + notSupportIdol[2].vocalStatus) * 0.2) * (1 + (0.1 * this.week)));
        baseAppeal.dance = Number.parseInt(((this.produceIdolStatus.danceStatus * 0.5) + ((supportIdol.danceStatus * 3) + notSupportIdol[0].danceStatus + notSupportIdol[1].danceStatus + notSupportIdol[2].danceStatus) * 0.2) * (1 + (0.1 * this.week)));
        baseAppeal.visual = Number.parseInt(((this.produceIdolStatus.visualStatus * 0.5) + ((supportIdol.visualStatus * 3) + notSupportIdol[0].visualStatus + notSupportIdol[1].visualStatus + notSupportIdol[2].visualStatus) * 0.2) * (1 + (0.1 * this.week)));
    ...
    calculateAppeal() {
      ...
      for(let i = 0 ; i < 4 ; i++) {
        ...
        if(skill.skillType === "Normal") {
          appeal.vocalPerfect =    (Number.parseInt(2 * (Number.parseInt(baseAppeal.vocal * 1.5 * this.buff.vocal)) * skill.vocalMagnification))
          ...
          appeal.dancePerfect =    (Number.parseInt((Number.parseInt(baseAppeal.vocal * 1.5 * this.buff.vocal)) * skill.vocalMagnification))
                                 + (Number.parseInt(2 * (Number.parseInt(baseAppeal.dance * 1.5 * this.buff.dance)) * skill.danceMagnification))
                                 + (Number.parseInt((Number.parseInt(baseAppeal.visual * 1.5 * this.buff.visual)) * skill.visualMagnification));
          ...
          appeal.vocalGood =    (Number.parseInt(2 * (Number.parseInt(baseAppeal.vocal * 1.1 * this.buff.vocal)) * skill.vocalMagnification))
          ...
          appeal.danceGood =    (Number.parseInt((Number.parseInt(baseAppeal.vocal * 1.1 * this.buff.vocal)) * skill.vocalMagnification))
                                 + (Number.parseInt(2 * (Number.parseInt(baseAppeal.dance * 1.1 * this.buff.dance)) * skill.danceMagnification))
                                 + (Number.parseInt((Number.parseInt(baseAppeal.visual * 1.1 * this.buff.visual)) * skill.visualMagnification));
          ...
          appeal.vocalNormal =    (Number.parseInt(2 * (Number.parseInt(baseAppeal.vocal * 1.0 * this.buff.vocal)) * skill.vocalMagnification))
          ...
          appeal.danceNormal =    (Number.parseInt((Number.parseInt(baseAppeal.vocal * 1.0 * this.buff.vocal)) * skill.vocalMagnification))
                                 + (Number.parseInt(2 * (Number.parseInt(baseAppeal.dance * 1.0 * this.buff.dance)) * skill.danceMagnification))
                                 + (Number.parseInt((Number.parseInt(baseAppeal.visual * 1.0 * this.buff.visual)) * skill.visualMagnification));
          ...
          appeal.vocalPerfect = (Number.parseInt(2 * (Number.parseInt(baseAppeal.vocal * 1.5 * this.buff.vocal)) * skill.vocalMagnification));
          appeal.dancePerfect = (Number.parseInt(2 * (Number.parseInt(baseAppeal.dance * 1.5 * this.buff.dance)) * skill.vocalMagnification));
          appeal.visualPerfect = (Number.parseInt(2 * (Number.parseInt(baseAppeal.visual * 1.5 * this.buff.visual)) * skill.vocalMagnification));
          appeal.vocalGood = (Number.parseInt(2 * (Number.parseInt(baseAppeal.vocal * 1.1 * this.buff.vocal)) * skill.vocalMagnification));
          appeal.danceGood = (Number.parseInt(2 * (Number.parseInt(baseAppeal.dance * 1.1 * this.buff.dance)) * skill.vocalMagnification));
          appeal.visualGood = (Number.parseInt(2 * (Number.parseInt(baseAppeal.visual * 1.1 * this.buff.visual)) * skill.vocalMagnification));
          appeal.vocalNormal = (Number.parseInt(2 * (Number.parseInt(baseAppeal.vocal * 1.0 * this.buff.vocal)) * skill.vocalMagnification));
          appeal.danceNormal = (Number.parseInt(2 * (Number.parseInt(baseAppeal.dance * 1.0 * this.buff.dance)) * skill.vocalMagnification));
          appeal.visualNormal = (Number.parseInt(2 * (Number.parseInt(baseAppeal.visual * 1.0 * this.buff.visual)) * skill.vocalMagnification));
          produceAppeal.push(appeal);
        }
      }
      ...
      for(let i = 0 ; i < 4 ; i++) {
        ...
        appeal.skillName = skill.skillName;
        if(skill.skillType === "Normal") {
          appeal.vocalPerfect =    (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].vocal * 1.5 * this.buff.vocal)) * skill.vocalMagnification))
          ...
          appeal.dancePerfect =    (Number.parseInt((Number.parseInt(supportBaseAppeal[i].vocal * 1.5 * this.buff.vocal)) * skill.vocalMagnification))
                                 + (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].dance * 1.5 * this.buff.dance)) * skill.danceMagnification))
                                 + (Number.parseInt((Number.parseInt(supportBaseAppeal[i].visual * 1.5 * this.buff.visual)) * skill.visualMagnification));
          ...
          appeal.vocalGood =    (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].vocal * 1.1 * this.buff.vocal)) * skill.vocalMagnification))
          ...
          appeal.danceGood =    (Number.parseInt((Number.parseInt(supportBaseAppeal[i].vocal * 1.1 * this.buff.vocal)) * skill.vocalMagnification))
                                 + (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].dance * 1.1 * this.buff.dance)) * skill.danceMagnification))
                                 + (Number.parseInt((Number.parseInt(supportBaseAppeal[i].visual * 1.1 * this.buff.visual)) * skill.visualMagnification));
          ...
          appeal.vocalNormal =    (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].vocal * 1.0 * this.buff.vocal)) * skill.vocalMagnification))
          ...
          appeal.danceNormal =    (Number.parseInt((Number.parseInt(supportBaseAppeal[i].vocal * 1.0 * this.buff.vocal)) * skill.vocalMagnification))
                                 + (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].dance * 1.0 * this.buff.dance)) * skill.danceMagnification))
                                 + (Number.parseInt((Number.parseInt(supportBaseAppeal[i].visual * 1.0 * this.buff.visual)) * skill.visualMagnification));
          ...
          appeal.vocalPerfect = (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].vocal * 1.5 * this.buff.vocal)) * skill.vocalMagnification));
          appeal.dancePerfect = (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].dance * 1.5 * this.buff.dance)) * skill.vocalMagnification));
          appeal.visualPerfect = (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].visual * 1.5 * this.buff.visual)) * skill.vocalMagnification));
          appeal.vocalGood = (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].vocal * 1.1 * this.buff.vocal)) * skill.vocalMagnification));
          appeal.danceGood = (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].dance * 1.1 * this.buff.dance)) * skill.vocalMagnification));
          appeal.visualGood = (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].visual * 1.1 * this.buff.visual)) * skill.vocalMagnification));
          appeal.vocalNormal = (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].vocal * 1.0 * this.buff.vocal)) * skill.vocalMagnification));
          appeal.danceNormal = (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].dance * 1.0 * this.buff.dance)) * skill.vocalMagnification));
          appeal.visualNormal = (Number.parseInt(2 * (Number.parseInt(supportBaseAppeal[i].visual * 1.0 * this.buff.visual)) * skill.vocalMagnification));
          produceAppeal.push(appeal);
        }
      }
